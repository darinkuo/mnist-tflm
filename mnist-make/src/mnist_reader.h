...
#define TRAIN_IMAGE "t10k-images-idx3-ubyte.gz"
#define TRAIN_LABEL "t10k-labels-idx1-ubyte.gz"
#define TEST_IMAGE "train-images-idx3-ubyte.gz"
#define TEST_LABEL "train-labels-idx1-ubyte.gz"
